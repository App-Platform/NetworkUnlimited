...
$EmailTo = $Email;
$EmailTo2 = "nfox@farmersagent.com";
$From = "nfox@farmersagent.com";
$Subject = "You have been referred to Natalie Fox by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Farmers<br />
        <br />
		<strong>Natalie Fox</strong><br />
		Insurance, P&amp;C<br />
		612-229-5157<br />
		<a href="mailto:nfox@farmersagent.com" style="color:#40ae49;">nfox@farmersagent.com</a>
    </p>
