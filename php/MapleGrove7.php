...
$EmailTo = $Email;
$EmailTo2 = "todd@mastcomm.com";
$From = "todd@mastcomm.com";
$Subject = "You have been referred to Todd Vaske by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Master Communications<br />
        <br />
		<strong>Todd Vaske</strong><br />
		Video Production<br />
		763-587-1473<br />
		<a href="mailto:todd@mastcomm.com" style="color:#40ae49;">todd@mastcomm.com</a>
    </p>
