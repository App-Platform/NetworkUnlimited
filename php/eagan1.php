...
$EmailTo = $Email;
$EmailTo2 = "bgomez@gcstitle.com";
$From = "bgomez@gcstitle.com";
$Subject = "You have been referred to Barb Gomez by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Liberty Title<br />
        <br />
		<strong>Barb Gomez</strong><br />
		Title<br />
		651-398-7221<br />
		<a href="mailto:bgomez@gcstitle.com" style="color:#40ae49;">bgomez@gcstitle.com</a>
    </p>
