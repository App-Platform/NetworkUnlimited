...
$EmailTo = $Email;
$EmailTo2 = "Cmadson22@yahoo.com";
$From = "Cmadson22@yahoo.com";
$Subject = "You have been referred to Colin Madson by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        North Face<br />
        <br />
		<strong>Colin Madson</strong><br />
		Outfitter<br />
		952-446-3309<br />
		<a href="mailto:Cmadson22@yahoo.com" style="color:#40ae49;">Cmadson22@yahoo.com</a>
    </p>
