...
$EmailTo = $Email;
$EmailTo2 = "eva.daniels@yahoo.com";
$From = "eva.daniels@yahoo.com";
$Subject = "You have been referred to Eva Daniels by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Guaranteed Rate<br />
        <br />
		<strong>Eva Daniels</strong><br />
		Mortgages<br />
		612-282-4703<br />
		<a href="mailto:eva.daniels@yahoo.com" style="color:#40ae49;">eva.daniels@yahoo.com</a>
    </p>
