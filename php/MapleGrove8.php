...
$EmailTo = $Email;
$EmailTo2 = "dsletten@gmail.com";
$From = "dsletten@gmail.com";
$Subject = "You have been referred to Dillon Sletten by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Centered Health<br />
        <br />
		<strong>Dillon Sletten</strong><br />
		Chiropractor<br />
		612-281-0898<br />
		<a href="mailto:dsletten@gmail.com" style="color:#40ae49;">dsletten@gmail.com</a>
    </p>
