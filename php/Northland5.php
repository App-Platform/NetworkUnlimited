...
$EmailTo = $Email;
$EmailTo2 = "rgriggs@pro-ns.net";
$From = "rgriggs@pro-ns.net";
$Subject = "You have been referred to Robert Riggs by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Riggs &amp; Associates<br />
        <br />
		<strong>Robert Riggs</strong><br />
		CPA<br />
		763-746-4111<br />
		<a href="mailto:rgriggs@pro-ns.net" style="color:#40ae49;">rgriggs@pro-ns.net</a>
    </p>
