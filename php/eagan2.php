...
$EmailTo = $Email;
$EmailTo2 = "darren1983@msn.com";
$From = "darren1983@msn.com";
$Subject = "You have been referred to Darren Jorgenson by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Remax Realty<br />
        <br />
		<strong>Darren Jorgenson</strong><br />
		Realtor<br />
		612-759-2178<br />
		<a href="mailto:darren1983@msn.com" style="color:#40ae49;">darren1983@msn.com</a>
    </p>
