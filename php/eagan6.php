...
$EmailTo = $Email;
$EmailTo2 = "daniel.mcgill@prudential.com";
$From = "daniel.mcgill@prudential.com";
$Subject = "You have been referred to Dan McGill by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Prudential<br />
        <br />
		<strong>Dan McGill</strong><br />
		Insurance<br />
		952-97-2675<br />
		<a href="mailto:daniel.mcgill@prudential.com" style="color:#40ae49;">daniel.mcgill@prudential.com</a>
    </p>
