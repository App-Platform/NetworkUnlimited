...
$EmailTo = $Email;
$EmailTo2 = "paulagiulliford@edinarealty.com";
$From = "paulagiulliford@edinarealty.com";
$Subject = "You have been referred to Paula Gulliford by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Edina Realty<br />
        <br />
		<strong>Paula Gulliford</strong><br />
		Realtor<br />
		612-840-5609<br />
		<a href="mailto:paulagiulliford@edinarealty.com" style="color:#40ae49;">paulagiulliford@edinarealty.com</a>
    </p>
