...
$EmailTo = $Email;
$EmailTo2 = "psandvik@comcast.net";
$From = "psandvik@comcast.net";
$Subject = "You have been referred to Pete Sandvik by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Perfect Circle Creative<br />
        <br />
		<strong>Pete Sandvik</strong><br />
		Graphic Design<br />
		612-986-2371<br />
		<a href="mailto:psandvik@comcast.net" style="color:#40ae49;">psandvik@comcast.net</a>
    </p>
