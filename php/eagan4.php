...
$EmailTo = $Email;
$EmailTo2 = "Gordon.brown@libertymutual.com";
$From = "Gordon.brown@libertymutual.com";
$Subject = "You have been referred to Gordon Brown by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
		...
		Insurance, P&amp;C<br />
		763-543-4344<br />
		<a href="mailto:Gordon.brown@libertymutual.com" style="color:#40ae49;">Gordon.brown@libertymutual.com</a>
    </p>
