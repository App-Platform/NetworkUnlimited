...
$EmailTo = $Email;
$EmailTo2 = "chad.shank@officeteam.com";
$From = "chad.shank@officeteam.com";
$Subject = "You have been referred to Chad Shank by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Office Team<br />
        <br />
		<strong>Chad Shank</strong><br />
		Printer<br />
		605-999-3069<br />
		<a href="mailto:chad.shank@officeteam.com" style="color:#40ae49;">chad.shank@officeteam.com</a>
    </p>
