...
$EmailTo = $Email;
$EmailTo2 = "joxford@stearns.com";
$From = "joxford@stearns.com";
$Subject = "You have been referred to Jeff Oxford by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Stearns Lending Inc.<br />
        <br />
		<strong>Jeff Oxford</strong><br />
		Mortgage<br />
		651-217-8625<br />
		<a href="mailto:joxford@stearns.com" style="color:#40ae49;">joxford@stearns.com</a>
    </p>
