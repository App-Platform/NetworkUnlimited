...
$EmailTo = $Email;
$EmailTo2 = "cari@shirtwerks.com";
$From = "cari@shirtwerks.com";
$Subject = "You have been referred to Cari Spears by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Shirtwerks<br />
        <br />
		<strong>Cari Spears</strong><br />
		Promotional Items<br />
		651-686-6343<br />
		<a href="mailto:cari@shirtwerks.com" style="color:#40ae49;">cari@shirtwerks.com</a>
    </p>
