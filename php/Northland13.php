...
$EmailTo = $Email;
$EmailTo2 = "david@thehomebusinesscompany.com";
$From = "david@thehomebusinesscompany.com";
$Subject = "You have been referred to David Carroll by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        IMS<br />
        <br />
		<strong>David Carroll</strong><br />
		Barter<br />
		612-802-8487<br />
		<a href="mailto:david@thehomebusinesscompany.com" style="color:#40ae49;">david@thehomebusinesscompany.com</a>
    </p>
