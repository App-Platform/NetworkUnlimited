...
$EmailTo = $Email;
$EmailTo2 = "Rollie.reis-mather@regus.com";
$From = "Rollie.reis-mather@regus.com";
$Subject = "You have been referred to Rollie Reis-Mather by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Regus<br />
        <br />
		<strong>Rollie Reis-Mather</strong><br />
		Commercial Office leasing<br />
		763-445-2502<br />
		<a href="mailto:Rollie.reis-mather@regus.com" style="color:#40ae49;">Rollie.reis-mather@regus.com</a>
    </p>
