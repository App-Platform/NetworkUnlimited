...
$EmailTo = $Email;
$EmailTo2 = "tschultz@marudas.com";
$From = "tschultz@marudas.com";
$Subject = "You have been referred to Tom Schultz by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Marudas<br />
        <br />
		<strong>Tom Schultz</strong><br />
		Promotional Products<br />
		651-697-7851<br />
		<a href="mailto:tschultz@marudas.com" style="color:#40ae49;">tschultz@marudas.com</a>
    </p>
