...
$EmailTo = $Email;
$EmailTo2 = "mike@hmtc.handymanmatter.com";
$From = "mike@hmtc.handymanmatter.com";
$Subject = "You have been referred to Mike Sitek by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Handy Man Matters<br />
        <br />
		<strong>Mike Sitek</strong><br />
		Handyman<br />
		952-949-0088<br />
		<a href="mailto:mike@hmtc.handymanmatter.com" style="color:#40ae49;">mike@hmtc.handymanmatter.com</a>
    </p>
