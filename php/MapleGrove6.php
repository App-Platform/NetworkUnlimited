...
$EmailTo = $Email;
$EmailTo2 = "kalmoeb@gmail.com";
$From = "kalmoeb@gmail.com";
$Subject = "You have been referred to Bruce Kalmoe by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Kalmoe CPA<br />
        <br />
		<strong>Bruce Kalmoe</strong><br />
		CPA<br />
		612-425-2368<br />
		<a href="mailto:kalmoeb@gmail.com" style="color:#40ae49;">kalmoeb@gmail.com</a>
    </p>
