...
$EmailTo = $Email;
$EmailTo2 = "vmartin@cundyandmartin.com";
$From = "vmartin@cundyandmartin.com";
$Subject = "You have been referred to Vince Martin by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Cundy &amp; Martin<br />
        <br />
		<strong>Vince Martin</strong><br />
		Immigration Attorney<br />
		952-746-4111<br />
		<a href="mailto:vmartin@cundyandmartin.com" style="color:#40ae49;">vmartin@cundyandmartin.com</a>
    </p>
