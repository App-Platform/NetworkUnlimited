...
$EmailTo = $Email;
$EmailTo2 = "dfylger@depthcommunications.com";
$From = "dfylger@depthcommunications.com";
$Subject = "You have been referred to Dax Flyger by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Depth Communications<br />
        <br />
		<strong>Dax Flyger</strong><br />
		Network &amp; Phone Systems<br />
		612-254-8006<br />
		<a href="mailto:dfylger@depthcommunications.com" style="color:#40ae49;">dfylger@depthcommunications.com</a>
    </p>
