...
$EmailTo = $Email;
$EmailTo2 = "Kirsten.butterfield@countryfinancial.com";
$From = "Kirsten.butterfield@countryfinancial.com";
$Subject = "You have been referred to Kirsten Butterfield by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        ...
        <br />
		<strong>Kirsten Butterfield</strong><br />
		Insurance P&amp;C<br />
		612-964-1580<br />
		<a href="mailto:Kirsten.butterfield@countryfinancial.com" style="color:#40ae49;">Kirsten.butterfield@countryfinancial.com</a>
    </p>
