...
$EmailTo = $Email;
$EmailTo2 = "ameester@primesignsmn.com";
$From = "ameester@primesignsmn.com";
$Subject = "You have been referred to Alan Meester by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        PrimeSigns<br />
        <br />
		<strong>Alan Meester</strong><br />
		Signs and Banners<br />
		952-767-3380<br />
		<a href="mailto:ameester@primesignsmn.com" style="color:#40ae49;">ameester@primesignsmn.com</a>
    </p>
