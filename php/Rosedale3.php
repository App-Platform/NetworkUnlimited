...
$EmailTo = $Email;
$EmailTo2 = "andrew.voorhees@regus.com";
$From = "andrew.voorhees@regus.com";
$Subject = "You have been referred to Andy Voorhees by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Regus<br />
        <br />
		<strong>Andy Voorhees</strong><br />
		Office Leasing<br />
		952-469-9261<br />
		<a href="mailto:andrew.voorhees@regus.com" style="color:#40ae49;">andrew.voorhees@regus.com</a>
    </p>
