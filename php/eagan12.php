...
$EmailTo = $Email;
$EmailTo2 = "adel.ragheb@associatedbank.com";
$From = "adel.ragheb@associatedbank.com";
$Subject = "You have been referred to Adel Ragheb by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Associated Bank<br />
        <br />
		<strong>Adel Ragheb</strong><br />
		Banker<br />
		651-554-8774<br />
		<a href="mailto:adel.ragheb@associatedbank.com" style="color:#40ae49;">adel.ragheb@associatedbank.com</a>
    </p>
