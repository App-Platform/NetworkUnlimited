...
$EmailTo = $Email;
$EmailTo2 = "jgonzalez@bulldogcontractorsllc.com";
$From = "jgonzalez@bulldogcontractorsllc.com";
$Subject = "You have been referred to Jamey Gonzalez by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Bulldog Contractors LLC<br />
        <br />
		<strong>Jamey Gonzalez</strong><br />
		Restoration/Roofing<br />
		612-232-0000<br />
		<a href="mailto:jgonzalez@bulldogcontractorsllc.com" style="color:#40ae49;">jgonzalez@bulldogcontractorsllc.com</a>
    </p>
