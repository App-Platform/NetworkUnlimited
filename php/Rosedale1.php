...
$EmailTo = $Email;
$EmailTo2 = "tcqr@comcast.netm";
$From = "tcqr@comcast.net";
$Subject = "You have been referred to Tom Greer by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Total Quality Realty<br />
        <br />
		<strong>Tom Greer</strong><br />
		Realtor<br />
		612-366-1045<br />
		<a href="mailto:tcqr@comcast.net" style="color:#40ae49;">tcqr@comcast.net</a>
    </p>
