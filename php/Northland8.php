...
$EmailTo = $Email;
$EmailTo2 = "marty@realmpromo.com";
$From = "marty@realmpromo.com";
$Subject = "You have been referred to Marty Stanchfield by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Realm Promos<br />
        <br />
		<strong>Marty Stanchfield</strong><br />
		Promotional Products<br />
		952-814-9000<br />
		<a href="mailto:marty@realmpromo.com" style="color:#40ae49;">marty@realmpromo.com</a>
    </p>
