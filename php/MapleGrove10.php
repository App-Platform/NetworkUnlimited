...
$EmailTo = $Email;
$EmailTo2 = "Jim.charlebois@countryfinancial.com";
$From = "Jim.charlebois@countryfinancial.com";
$Subject = "You have been referred to Jim Charlebois by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        ...
        <br />
		<strong>Jim Charlebois</strong><br />
		Insurance P&amp;C<br />
		612-363-4104<br />
		<a href="mailto:Jim.charlebois@countryfinancial.com" style="color:#40ae49;">Jim.charlebois@countryfinancial.com</a>
    </p>
