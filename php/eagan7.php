...
$EmailTo = $Email;
$EmailTo2 = "aliciamoroney@yahoo.com";
$From = "aliciamoroney@yahoo.com";
$Subject = "You have been referred to Alicia Moroney by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        StayinAlive CPR<br />
        <br />
		<strong>Alicia Moroney</strong><br />
		CPR<br />
		651-271-5568<br />
		<a href="mailto:aliciamoroney@yahoo.com" style="color:#40ae49;">aliciamoroney@yahoo.com</a>
    </p>
