...
$EmailTo = $Email;
$EmailTo2 = "Theresa@libertytitleinc.us";
$From = "Theresa@libertytitleinc.us";
$Subject = "You have been referred to Theresa Wellinski by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Liberty Title<br />
        <br />
		<strong>Theresa Wellinski</strong><br />
		Title Services<br />
		763-494-0340<br />
		<a href="mailto:Theresa@libertytitleinc.us" style="color:#40ae49;">Theresa@libertytitleinc.us</a>
    </p>
