...
$EmailTo = $Email;
$EmailTo2 = "jim@jimcarlson.com";
$From = "jim@jimcarlson.com";
$Subject = "You have been referred to Jim Carlson by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Carlson Financial Strategies<br />
        <br />
		<strong>Jim Carlson</strong><br />
		Financial Planner<br />
		952-646-9225<br />
		<a href="mailto:jim@jimcarlson.com" style="color:#40ae49;">jim@jimcarlson.com</a>
    </p>
