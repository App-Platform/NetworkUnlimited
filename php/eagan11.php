...
$EmailTo = $Email;
$EmailTo2 = "jerry@mortgageresultsinc.com";
$From = "jerry@mortgageresultsinc.com";
$Subject = "You have been referred to Jerry Doffing by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Mortgage Results<br />
        <br />
		<strong>Jerry Doffing</strong><br />
		Mortgage<br />
		952-895-5544<br />
		<a href="mailto:jerry@mortgageresultsinc.com" style="color:#40ae49;">jerry@mortgageresultsinc.com</a>
    </p>
