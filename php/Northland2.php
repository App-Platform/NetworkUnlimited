...
$EmailTo = $Email;
$EmailTo2 = "curt@wisshgraphics.com";
$From = "curt@wisshgraphics.com";
$Subject = "You have been referred to Curt Wussow by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        WISSH Graphics<br />
        <br />
		<strong>Curt Wussow</strong><br />
		Graphic Designer<br />
		952-476-1385<br />
		<a href="mailto:curt@wisshgraphics.com" style="color:#40ae49;">curt@wisshgraphics.com</a>
    </p>
