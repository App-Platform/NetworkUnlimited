...
$EmailTo = $Email;
$EmailTo2 = "brendals@live.com";
$From = "brendals@live.com";
$Subject = "You have been referred to Brenda Stulac-Rick by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Evolv<br />
        <br />
		<strong>Brenda Stulac-Rick</strong><br />
		Health &amp; Wellness<br />
		763-228-6139<br />
		<a href="mailto:brendals@live.com" style="color:#40ae49;">brendals@live.com</a>
    </p>
