...
$EmailTo = $Email;
$EmailTo2 = "Stephanie@theimagery.net";
$From = "Stephanie@theimagery.net";
$Subject = "You have been referred to Stephanie Oman by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        The Imagery<br />
        <br />
		<strong>Stephanie Oman</strong><br />
		Photographer<br />
		952-890-7640<br />
		<a href="mailto:Stephanie@theimagery.net" style="color:#40ae49;">Stephanie@theimagery.net</a>
    </p>
