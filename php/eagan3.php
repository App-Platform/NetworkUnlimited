...
$EmailTo = $Email;
$EmailTo2 = "Lindsay@corporate1st.com";
$From = "Lindsay@corporate1st.com";
$Subject = "You have been referred to Lindsay Moroney by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        ForeFront Social Media<br />
        <br />
		<strong>Lindsay Moroney</strong><br />
		651-285-3707<br />
		<a href="mailto:Lindsay@corporate1st.com" style="color:#40ae49;">Lindsay@corporate1st.com</a>
    </p>
