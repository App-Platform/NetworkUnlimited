...
$Subject = "You have been referred to Mark Moroney by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Corporate 1<sup>st</sup> Impressione<br />
        <br />
		<strong>Mark Moroney</strong><br />
		Marketing<br />
		612-598-1290<br />
		<a href="mailto:mark@corporate1st.com" style="color:#40ae49;">mark@corporate1st.com</a>
    </p>
