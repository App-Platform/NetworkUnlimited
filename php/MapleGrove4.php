...
$EmailTo = $Email;
$EmailTo2 = "sswanson@nova-communications.com";
$From = "sswanson@nova-communications.com";
$Subject = "You have been referred to Shannon Swanson by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        ...
        <br />
		<strong>Shannon Swanson</strong><br />
		Business Phone Systems<br />
		763-439-1505<br />
		<a href="mailto:sswanson@nova-communications.com" style="color:#40ae49;">sswanson@nova-communications.com</a>
    </p>
