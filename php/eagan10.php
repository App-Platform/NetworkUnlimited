...
$EmailTo = $Email;
$EmailTo2 = "gwebb@minutemanpress.com";
$From = "gwebb@minutemanpress.com";
$Subject = "You have been referred to Gary Webb by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Minuteman Press<br />
        <br />
		<strong>Gary Webb</strong><br />
		Printer<br />
		952-808-0000<br />
		<a href="mailto:gwebb@minutemanpress.com" style="color:#40ae49;">gwebb@minutemanpress.com</a>
    </p>
