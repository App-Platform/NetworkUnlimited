...
$EmailTo = $Email;
$EmailTo2 = "buzzexteriors@gmail.com";
$From = "buzzexteriors@gmail.com";
$Subject = "You have been referred to Olga Boz by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Buzz Exteriors<br />
        <br />
		<strong>Olga Boz</strong><br />
		Roofing Remodeling<br />
		651-288-6151<br />
		<a href="mailto:buzzexteriors@gmail.com" style="color:#40ae49;">buzzexteriors@gmail.com</a>
    </p>
