...
$EmailTo = $Email;
$EmailTo2 = "mking@litin.com";
$From = "mking@litin.com";
$Subject = "You have been referred to Monica King by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Littin<br />
        <br />
		<strong>Monica King</strong><br />
		Paper, Packaging, Shipping &amp; Food service supplies<br />
		715-377-8655<br />
		<a href="mailto:mking@litin.com" style="color:#40ae49;">mking@litin.com</a>
    </p>
