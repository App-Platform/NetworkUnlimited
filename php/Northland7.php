...
$EmailTo = $Email;
$EmailTo2 = "Joe.malmberg@topdogpc.com";
$From = "Joe.malmberg@topdogpc.com";
$Subject = "You have been referred to Joe Malmberg by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Top Dog PC<br />
        <br />
		<strong>Joe Malmberg</strong><br />
		Computer IT Services<br />
		651-217-1237<br />
		<a href="mailto:Joe.malmberg@topdogpc.com" style="color:#40ae49;">Joe.malmberg@topdogpc.com</a>
    </p>
