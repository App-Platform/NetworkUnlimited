...
$EmailTo = $Email;
$EmailTo2 = "myhometeam@kw.com";
$From = "myhometeam@kw.com";
$Subject = "You have been referred to Tammy Chevalier by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Keller Williams<br />
        <br />
		<strong>Tammy Chevalier</strong><br />
		Realtor<br />
		612-850-0866<br />
		<a href="mailto:myhometeam@kw.com" style="color:#40ae49;">myhometeam@kw.com</a>
    </p>
