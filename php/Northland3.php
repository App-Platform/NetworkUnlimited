...
$EmailTo = $Email;
$EmailTo2 = "corey.stich@oaktree-insurance.com";
$From = "corey.stich@oaktree-insurance.com";
$Subject = "You have been referred to Corey Stich by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        Oak Tree Insurance<br />
        <br />
		<strong>Corey Stich</strong><br />
		Insurance P&amp;C<br />
		952-469-9261<br />
		<a href="mailto:corey.stich@oaktree-insurance.com" style="color:#40ae49;">corey.stich@oaktree-insurance.com</a>
    </p>
