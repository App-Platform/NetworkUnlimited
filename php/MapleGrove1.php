...
$EmailTo = $Email;
$EmailTo2 = "tsample@waterstonemortgage.com";
$From = "tsample@waterstonemortgage.com";
$Subject = "You have been referred to Tonya Sample by " . $Name;
$Subject2 = "Referral";
$headers = "From: $From" . "\r\n";
...
<div style="margin-left:auto; margin-right:auto; margin-top:20px; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        ...
        <br />
		<strong>Tonya Sample</strong><br />
		Mortgage Planner<br />
		763-213-2195<br />
		<a href="mailto:tsample@waterstonemortgage.com" style="color:#40ae49;">tsample@waterstonemortgage.com</a>
    </p>
